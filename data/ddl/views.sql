...
-- 1) Cadastro / Perfil
COMMENT ON MATERIALIZED VIEW view_fiis_info IS 'Informações cadastrais completas de cada Fundo Imobiliário listado na B3 (1 linha por fundo).||ask:intents=cadastro;keywords=cadastro,ficha,perfil,cnpj,site,website,administrador,custodiante,gestor,tipo,segmento,classificação,publico-alvo,ipo,isin,b3,constituição,enterprise value,taxa de crescimento,retorno por cota,gestão ativa,gestão passiva;synonyms.cadastro=cadastro,perfil,ficha,informações,cnpj,administrador,gestor,custodiante,site,site oficial,website,tipo,segmento,classificação,público-alvo,ipo,isin,nome b3,valor de mercado,market cap,p/vp,preço sobre patrimônio,sharpe,volatilidade,dividend payout,índice de payout,cap rate,ev,enterprise value,eps,rps,equity per share,revenue per share,data de constituição,constituição,gestão ativa,gestão passiva,taxa de crescimento,crescimento,retorno por cota;latest_words=último,últimos,mais recente,recente,atual;timewords=hoje,ontem,janeiro,fevereiro,março,abril,maio,junho,julho,agosto,setembro,outubro,novembro,dezembro;weights.keywords=1;weights.synonyms=2;intent_tokens={"cadastro":["cnpj","administrador","custodiante","gestão","gestao","público","alvo","ipo","isin","segmento","website","site","oficial","exclusivo","constituição","constituicao","patrimônio","patrimonio","pvp","payout","enterprise","value","equity","crescimento","taxa","retorno","cota","cap","rate","market","volatilidade","sharpe","gestão ativa","gestão passiva","data de constituição","retorno por cota"]};';
-- 2) Dividendos (histórico / últimos)
COMMENT ON MATERIALIZED VIEW view_fiis_history_dividends IS 'Histórico detalhado de dividendos distribuídos por cada FII, incluindo datas de pagamento e valores declarados.||ask:intents=dividends,historico;keywords=dividendo,dividendos,rendimentos,rendimento,provento,proventos,histórico,último,mais recente,yield,dy,repasse;synonyms.dividends=dividendo,dividendos,rendimentos,proventos,pagamentos,repasse,yield,dy,pagou,pago,pagos;synonyms.historico=histórico,histórico de dividendos,mês a mês,anual,total,linha do tempo;latest_words=último,últimos,mais recente,recente,atual;timewords=hoje,ontem,mes passado,mês anterior,ano atual,12 meses,janeiro,fevereiro,março,abril,maio,junho,julho,agosto,setembro,outubro,novembro,dezembro;weights.keywords=1;weights.synonyms=2;intent_tokens={"dividends":["dividendo","dividendos","provento","proventos","yield","dy","rendimento","pagamento","pagamentos","pagou","pago","pagos"],"historico":["histórico","históricos","linha","tempo"]};';
-- 3) Ativos / Imóveis (portfólio)
COMMENT ON MATERIALIZED VIEW view_fiis_history_assets IS 'Relação completa dos ativos e imóveis integrantes do portfólio de cada FII, com localização e características principais.||ask:intents=ativos,imoveis;keywords=imóvel,imoveis,ativo,ativos,asset,endereço,localização,portfólio,propriedade,shopping,galpão,cri,papel;synonyms.ativos=imóveis,ativos,bens,propriedades,portfólio,empreendimentos,galpões,shoppings,lojas,crIs,papéis,cotas de fundos,participações;synonyms.imoveis=imóveis,propriedades,ativos físicos;weights.keywords=1;weights.synonyms=2;intent_tokens={"ativos":["imóvel","imóveis","portfólio","galpão","shopping","ativo","ativos","carteira","propriedade","empreendimento","cota","cotas","fundo","fundos","participação","participacoes"],"imoveis":["imóvel","imóveis","propriedade","imobiliário"]};';
-- 4) Processos judiciais
COMMENT ON MATERIALIZED VIEW view_fiis_history_judicial IS 'Processos judiciais e ações legais associadas a cada Fundo Imobiliário, incluindo número do processo, valor da causa e status da instância.||ask:intents=judicial,processos;keywords=judicial,processo,processos,ações judiciais,ação,ações,instância,instâncias,valor da causa,riscos,litígio,litígios,decisão,cível,trabalhista,administrativo,cvm;synonyms.judicial=processo,processos,ação,ações,litígio,litígios,demanda,causa,processos administrativos,cvm,trabalhista,cível,processado,processados,processada,processadas;latest_words=hoje,último,recente;weights.keywords=1;weights.synonyms=2;intent_tokens={"judicial":["processo","processos","judicial","judiciais","ação","ações","instância","instâncias","litígio","litígios","processado","processados"]};';
-- 5) Preços (série temporal / último)
COMMENT ON MATERIALIZED VIEW view_fiis_history_prices IS 'Série temporal de preços dos FIIs, contemplando valores de abertura, fechamento, máxima e mínima.||ask:intents=precos,historico;keywords=preço,preços,fechamento,abertura,alta,baixa,histórico,gráfico,cotação,cota,média móvel,tendência,preço de fechamento;synonyms.precos=preço,cotação,valor,fechamento,cota,última cotação,atual,ontem,hoje,subiu,caiu,valendo;synonyms.historico=histórico,evolução de preços,série temporal,gráfico;latest_words=último,últimos,mais recente,recente,atual,hoje;timewords=hoje,ontem,mes passado,mês anterior,ano atual,30 dias,janeiro,fevereiro,março,abril,maio,junho,julho,agosto,setembro,outubro,novembro,dezembro;weights.keywords=1;weights.synonyms=2;intent_tokens={"precos":["preço","preços","cotação","fechou","subiu","caiu","tendência","média","móvel","gráfico","variação","valor","valendo"],"historico":["histórico","históricos","evolução"]};';
...
COMMENT ON MATERIALIZED VIEW view_market_indicators IS 'Indicadores e índices de mercado relevantes para o universo de FIIs, como IFIX, CDI, SELIC, dólar e euro.||ask:intents=indicadores,mercado;keywords=ifix,ifil,ibov,cdi,selic,dólar,euro,indicadores,benchmark,referência,ipca,igpm,incc;synonyms.indicadores=indicadores,índices,taxas,benchmarks,ipca,igpm,incc,inflação;latest_words=último,mais recente,atual;timewords=hoje,ontem,acumulado,12 meses,ano,2024,2025,janeiro,...,dezembro;weights.keywords=1;weights.synonyms=2;intent_tokens={"indicadores":["ifix","ifil","ibov","cdi","selic","dólar","euro","ipca","igpm","incc","juros","taxa","indicador"],"mercado":["mercado","taxas","índices"]};';
-- 8) Taxas/índices econômicos diários (séries)
COMMENT ON MATERIALIZED VIEW view_history_taxes IS 'Séries históricas de taxas financeiras e índices econômicos diários, incluindo CDI, SELIC e poupança.||ask:intents=taxas,diario;keywords=cdi,selic,poupança,juros,índices,diário,ipca,igpm,incc;synonyms.taxas=taxas,juros,índices,indicadores,diário,diaria;latest_words=último,mais recente,atual;timewords=hoje,ontem,acumulado,no ano,12 meses,janeiro,...,dezembro;weights.keywords=1;weights.synonyms=2;intent_tokens={"indicadores":["cdi","selic","poupança","juros","índice","ipca","igpm","incc","taxa"],"precos":["preço","cotação"],"dividends":["dividendo","yield"],"cadastro":["cnpj"],"ativos":["ativo"],"judicial":["processo"]};';
...
COMMENT ON COLUMN view_fiis_info.management_type IS 'Tipo de gestão (ativa/passiva).|Tipo de gestão ||col={"intents":["cadastro"],"synonyms":{"cadastro":["gestão ativa","gestão passiva","ativa","passiva"]}}';
COMMENT ON COLUMN view_fiis_info.target_market IS 'Público alvo.|Público alvo';
COMMENT ON COLUMN view_fiis_info.is_exclusive IS 'Indica se o fundo é exclusivo (boolean).|Fundo exclusivo ||col={"intents":["cadastro"],"synonyms":{"cadastro":["fundo exclusivo","exclusivo"]}}';
...
COMMENT ON COLUMN view_fiis_info.website_url IS 'URL oficial do fundo.|Site oficial ||col={"intents":["cadastro"],"synonyms":{"cadastro":["site oficial","website","site"]}}';
...
COMMENT ON COLUMN view_fiis_info.market_cap_value IS 'Valor de mercado do fundo.|Valor de mercado ||col={"intents":["cadastro"],"synonyms":{"cadastro":["valor de mercado","market cap"]}}';
COMMENT ON COLUMN view_fiis_info.enterprise_value IS 'Enterprise value (valor da firma).|Valor da firma ||col={"intents":["cadastro"],"synonyms":{"cadastro":["enterprise value","valor da firma","ev"]}}';
COMMENT ON COLUMN view_fiis_info.price_book_ratio IS 'Índice Preço/Patrimônio.|P/VP ||col={"intents":["cadastro"],"synonyms":{"cadastro":["p/vp","preço sobre patrimônio","preço patrimônio"]}}';
COMMENT ON COLUMN view_fiis_info.equity_per_share IS 'Patrimônio líquido por cota.|VPA ||col={"intents":["cadastro"],"synonyms":{"cadastro":["equity per share","patrimônio por cota","vpa"]}}';
COMMENT ON COLUMN view_fiis_info.revenue_per_share IS 'Receita por cota.|Receita por cota ||col={"intents":["cadastro"],"synonyms":{"cadastro":["revenue per share","retorno por cota","receita por cota"]}}';
COMMENT ON COLUMN view_fiis_info.dividend_payout_pct IS 'Payout ratio em percentual.|Dividend Payout ||col={"intents":["cadastro"],"synonyms":{"cadastro":["dividend payout","payout","índice de payout"]}}';
COMMENT ON COLUMN view_fiis_info.growth_rate IS 'Taxa de crescimento percentual.|Crescimento do patrimônio ||col={"intents":["cadastro"],"synonyms":{"cadastro":["taxa de crescimento","crescimento"]}}';
COMMENT ON COLUMN view_fiis_info.cap_rate IS 'Cap rate percentual.|Taxa de capitalização ||col={"intents":["cadastro"],"synonyms":{"cadastro":["cap rate","taxa de capitalização"]}}';
COMMENT ON COLUMN view_fiis_info.volatility_ratio IS 'Volatilidade percentual.|Volatilidade ||col={"intents":["cadastro"],"synonyms":{"cadastro":["volatilidade"]}}';
COMMENT ON COLUMN view_fiis_info.sharpe_ratio IS 'Índice de Sharpe.|Sharpe ||col={"intents":["cadastro"],"synonyms":{"cadastro":["sharpe","índice de sharpe","sharpe ratio"]}}';
...
COMMENT ON COLUMN view_fiis_history_prices.close_price IS 'Preço de fechamento.|Fechamento ||col={"intents":["precos"],"synonyms":{"precos":["fechou","fechamento","preço de fechamento","close"]},"weights":{"synonyms":2}}';
