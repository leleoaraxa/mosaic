...
-- 1) Cadastro / Perfil
COMMENT ON MATERIALIZED VIEW view_fiis_info IS 'Informações cadastrais completas de cada Fundo Imobiliário listado na B3 (1 linha por fundo).||ask:intents=cadastro;keywords=cadastro,ficha,perfil,cnpj,site,administrador,custodiante,gestor,tipo,segmento,classificação,publico-alvo,ipo,isin,b3;synonyms.cadastro=cadastro,perfil,ficha,informações,cnpj,administrador,gestor,custodiante,site,tipo,segmento,classificação,público-alvo,ipo,isin,nome b3,valor de mercado,p/vp,market cap,sharpe,volatilidade,dividend payout,cap rate,ev,eps,rps,equity per share,revenue per share;latest_words=último,últimos,mais recente,recente,atual;timewords=hoje,ontem,janeiro,fevereiro,março,abril,maio,junho,julho,agosto,setembro,outubro,novembro,dezembro;weights.keywords=1;weights.synonyms=2;intent_tokens={"cadastro":["cnpj","administrador","custodiante","gestão","público","alvo","ipo","isin","segmento","website","exclusivo","patrimônio","pvp","payout","enterprise","value","equity","crescimento"],"ativos":["imóvel","imóveis","portfólio","galpão","shopping","ativo","ativos","carteira"],"precos":["preço","preços","cotação","valor","variação"],"dividends":["dividendo","provento","yield","dy","rendimento"],"indicadores":["ipca","igpm","incc","selic","cdi"],"judicial":["processo","processos","judicial","ação"]};';
-- 2) Dividendos (histórico / últimos)
COMMENT ON MATERIALIZED VIEW view_fiis_history_dividends IS 'Histórico detalhado de dividendos distribuídos por cada FII, incluindo datas de pagamento e valores declarados.||ask:intents=dividends,historico;keywords=dividendo,dividendos,rendimentos,rendimento,provento,proventos,histórico,último,mais recente,yield,dy,repasse;synonyms.dividends=dividendo,dividendos,rendimentos,proventos,pagamentos,repasse,yield,dy;synonyms.historico=histórico,histórico de dividendos,mês a mês,anual,total,linha do tempo;latest_words=último,últimos,mais recente,recente,atual;timewords=hoje,ontem,mes passado,mês anterior,ano atual,12 meses,janeiro,fevereiro,março,abril,maio,junho,julho,agosto,setembro,outubro,novembro,dezembro;weights.keywords=1;weights.synonyms=2;intent_tokens={"dividends":["dividendo","dividendos","provento","proventos","yield","dy","rendimento","pagamento","pagamentos"],"precos":["preço","preços","cotação","valor"],"cadastro":["cnpj","administrador","gestão"],"ativos":["ativo","ativos","carteira"],"judicial":["processo","judicial"],"indicadores":["ipca","igpm","incc","selic","cdi"]};';
-- 3) Ativos / Imóveis (portfólio)
COMMENT ON MATERIALIZED VIEW view_fiis_history_assets IS 'Relação completa dos ativos e imóveis integrantes do portfólio de cada FII, com localização e características principais.||ask:intents=ativos,imoveis;keywords=imóvel,imoveis,ativo,ativos,asset,endereço,localização,portfólio,propriedade,shopping,galpão,cri,papel;synonyms.ativos=imóveis,ativos,bens,propriedades,portfólio,empreendimentos,galpões,shoppings,lojas,crIs,papéis;weights.keywords=1;weights.synonyms=2;intent_tokens={"ativos":["imóvel","imóveis","portfólio","galpão","shopping","ativo","ativos","carteira","propriedade","empreendimento"],"precos":["preço","preços","cotação"],"dividends":["dividendo","provento","yield","dy"],"cadastro":["cnpj","gestor","administrador"],"judicial":["processo","judicial"],"indicadores":["ipca","igpm","incc","selic","cdi"]};';
-- 4) Processos judiciais
COMMENT ON MATERIALIZED VIEW view_fiis_history_judicial IS 'Processos judiciais e ações legais associadas a cada Fundo Imobiliário, incluindo número do processo, valor da causa e status da instância.||ask:intents=judicial,processos;keywords=judicial,processo,processos,ação,instância,valor da causa,riscos,litígio,decisão,cível,trabalhista,administrativo,cvm;synonyms.judicial=processo,ação,litígio,demanda,causa,processos administrativos,cvm,trabalhista,cível;latest_words=hoje,último,recente;weights.keywords=1;weights.synonyms=2;intent_tokens={"judicial":["processo","processos","judicial","ação","instância"],"ativos":["imóvel","imóveis","portfólio","galpão","shopping"],"precos":["preço","preços","cotação"],"dividends":["dividendo","provento","yield","dy"],"indicadores":["ipca","igpm","incc","selic","cdi"]};';
-- 5) Preços (série temporal / último)
COMMENT ON MATERIALIZED VIEW view_fiis_history_prices IS 'Série temporal de preços dos FIIs, contemplando valores de abertura, fechamento, máxima e mínima.||ask:intents=precos,historico;keywords=preço,preços,fechamento,abertura,alta,baixa,histórico,gráfico,cotação,cota,média móvel,tendência,preço de fechamento;synonyms.precos=preço,cotação,valor,fechamento,cota,última cotação,atual,ontem,hoje;synonyms.historico=histórico,evolução de preços,série temporal,gráfico;latest_words=último,últimos,mais recente,recente,atual,hoje;timewords=hoje,ontem,mes passado,mês anterior,ano atual,30 dias,janeiro,fevereiro,março,abril,maio,junho,julho,agosto,setembro,outubro,novembro,dezembro;weights.keywords=1;weights.synonyms=2;intent_tokens={"precos":["preço","preços","cotação","fechou","subiu","caiu","tendência","média","móvel","gráfico","variação","valor"],"dividends":["dividendo","dividendos","provento","proventos","yield","dy","rendimento","pagamento","pagamentos"],"ativos":["imóvel","imóveis","portfólio","galpão","shopping","ativo","ativos","cota","cotas","carteira","cri","papel"],"judicial":["processo","processos","judicial","ação","instância"],"indicadores":["ipca","igpm","incc","selic","cdi"],"cadastro":["cnpj","administrador","custodiante","gestão","público","alvo","ipo","isin","segmento","website","exclusivo","patrimônio","pvp","payout"],"historico":["histórico","históricos"]};';
