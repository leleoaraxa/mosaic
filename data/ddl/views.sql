...
COMMENT ON MATERIALIZED VIEW view_history_taxes IS 'Histórico diário de taxas e índices.||ask:intents=taxas,diario;keywords=ifix,ifil,ibov,cdi,selic,dólar,euro,diário,poupança';
